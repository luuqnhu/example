...
class ReportFireController extends Controller
{
    ...
    {
        $reportFireLogic = new ReportFireLogic($this->get('aws.dynamodb'));
        $response = $reportFireLogic->sendNotificationGCM("Message", "d-tBRQgYL2M:APA91bGYLtYucBX70v4x6YqAYUU5BZpxmu8WnVnd6SV13WSBDOfM-dI7WEl1Lp4gEyzVNrNumYgRI3LajOLg67zbECjUtC-vgjzXo_QmGDupqer5AO8FGr928oJu5bXsjqF6f0zCHNvD");
        return $response;
    }
